...
export function RegisterForm() {
  ...
  const handleRegister = async (e) => {
    ...
    try {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
      ...
      console.log("// Step 1: register with only email/password/username")
      ...
      console.log("// step 2: update the user with firstName and lastName")
      await axios.put(
      ...
      console.log("// step 3: sign in the user with next-auth")
